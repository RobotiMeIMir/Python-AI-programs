...
# ✅ Fix Windows event loop issue (avoids RuntimeError: Event loop is closed)
...
# Translate text using Google Translate API (async)
async def translate_text(text, target_language="es"):  # Default target language is Spanish (es)
...
def display_language_options():
    ...
    print("8. Punjabi (pa)")
    print("9. Albanian (sq)")  # ✅ Added Albanian
...
def main():
    ...
    if original_text:
        # Step 3: Translate to selected target language (async call)
