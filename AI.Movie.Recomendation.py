...
def load_data(file_path='C:/Users/KlodiShpetimi/Downloads/imdb_top_1000.csv'):
    try:
...
def recommend_movies(genre=None, mood=None, rating=None, top_n=5):
    ...
    return recommendations if recommendations else "No suitable movie recommandations found"
...
def handle_ai(name):
    ...
    while True:
        ...
        if genre_input.isdigit() and 1 <= int(genre_input) <= len(genres):
            ...
            break
        elif genre_input.title() in genres: #Will convert the string first ketter capital
    ...
    print(Fore.BLUE + "nAnalyzing mood", end="", flush=True)
    ...
    while True:
        ...
        try:
            ...
            if 7.6 <= rating <= 9.3:
                break
            print(Fore.RED + "Rating out og range. Try again. \n")
        except ValueError:
            print(Fore.RED + "Invalid input. Try again. \n")
