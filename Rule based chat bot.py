...
destinations = {
    ...
    "mountains": ["Swiss Alps", "Mount Everest", "Rocky Mountains"],
    "cities": ["Tokyo", "Paris", "New York"],
}
jokes = [
    "Why don't programmers like nature? Too many bugs.🐛",
    "Why did the computer go to the doctor? Because he caught a virus.🦠",
...
def packing_tips():
    ...
    print(Fore.GREEN + f"TravelBot: Packing tips for {days}")
