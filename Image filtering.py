...
def display_image(title, image):
    ...
    plt.figure(figsize=(8, 8)) #8 by 8 cm matrix
...
def interactive_edge_detection(image_path):
    """Interactive for edge detection and filtering"""
    ...
    while True:
        ...
        if choice == "1":
            ...
            display_image("Cannt Edge Detector", edges)
            ...
            print("Adjust kernel size for Gaussian blurr (must be odd, default: 5)")
...
interactive_edge_detection('C:/Users/KlodiShpetimi/Pictures/TOMATO.jpg')